...
from scanview_agent.source_segmentation_reviews import ARTIFACT_TYPE as SOURCE_SEGMENTATION_REVIEW_ARTIFACT_TYPE
from scanview_agent.viewer_state import SCHEMA_VERSION as VIEWER_STATE_SCHEMA_VERSION


def main() -> None:
    if version("scanview-agent") != "0.14.0" or version("pydicom") != "3.0.2":
    ...
    if SOURCE_SEGMENTATION_REVIEW_ARTIFACT_TYPE != "scanview.source-segmentation-review":
        raise SystemExit("installed ScanView source-SEG review contract is unavailable")
