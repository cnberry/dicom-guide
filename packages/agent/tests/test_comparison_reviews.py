...
from scanview_agent.comparison_reviews import (
    EXPECTED_FILES,
...
def test_review_packet_binds_visual_and_numeric_evidence_with_static_schema_valid_output(
    ...
    with zipfile.ZipFile(output) as archive:
        ...
        assert "NO RESPONSE CONCLUSION GENERATED BY SCANVIEW" in review_html
    ...
    schema = json.loads(
        (repository_root / "schemas" / "scanview-comparison-review-v1.schema.json").read_text()
    )
