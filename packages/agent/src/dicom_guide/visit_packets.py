...
<head>
  ...
  <title>DICOM Guide unreviewed clinician visit packet</title>
  <style>
...
<body><main>
  <h1>DICOM Guide clinician visit packet</h1>
  ...
  <footer>Original DICOM instances remain authoritative. Validate this archive locally with dicom-guide before use. This packet may contain sensitive medical imagery.</footer>
</main></body></html>\n"""
...
def _render_readme() -> bytes:
    return (
        "DICOM Guide clinician visit packet\n"
        "\n"
        ...
        "4. Validate locally: dicom-guide validate-visit-packet <archive.zip>\n"
        "\n"
...
def build_visit_packet(
    ...
    *,
    ...
    packet: dict[str, Any] = {
        ...
        "implementation": {
            "name": "DICOM Guide clinician visit-packet assembler",
            "version": "0.1.0",
        },
        "files": {},
    }
