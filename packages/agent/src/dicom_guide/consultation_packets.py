...
IMPLEMENTATION = {
    "name": "DICOM Guide clinician consultation-packet assembler",
    "version": "0.1.0",
}
...
<head>
  ...
  <title>DICOM Guide unreviewed clinician consultation packet</title>
  <style>
...
<body><main>
  <h1>DICOM Guide clinician consultation packet</h1>
  ...
  <footer>Original DICOM instances remain authoritative. Validate this archive locally with dicom-guide before use. This packet contains sensitive medical imagery and may contain identifying pixels.</footer>
</main></body></html>\n"""
...
def _render_readme() -> bytes:
    return (
        "DICOM Guide clinician consultation packet\n"
        "\n"
        ...
        "4. Validate locally: dicom-guide validate-consultation-packet <archive.zip>\n"
        "\n"
