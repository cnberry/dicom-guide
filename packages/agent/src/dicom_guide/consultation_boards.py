...
IMPLEMENTATION = {
    "name": "DICOM Guide clinician consultation-board assembler",
    "version": "0.1.0",
}
MIN_ITEMS = 2
MAX_ITEMS = 8
...
LIMITATIONS = [
    ...
    "Discussion labels are person-entered headings and have not been clinically authenticated or interpreted by DICOM Guide.",
...
<head>
  ...
  <title>DICOM Guide unreviewed clinician consultation evidence board</title>
  <style>
...
<body><main>
  <h1>DICOM Guide clinician consultation evidence board</h1>
  ...
  <footer>Original DICOM instances remain authoritative. Validate this archive locally with dicom-guide before use. This board contains sensitive medical imagery and may contain identifying pixels.</footer>
</main></body></html>\n"""
...
def _render_readme() -> bytes:
    return (
        "DICOM Guide clinician consultation evidence board\n"
        "\n"
        ...
        "4. Validate locally: dicom-guide validate-consultation-board <archive.zip>\n"
        "\n"
