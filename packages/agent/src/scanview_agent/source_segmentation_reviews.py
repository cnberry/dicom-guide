...
ARTIFACT_TYPE = "scanview.source-segmentation-review"
REQUEST_ARTIFACT_TYPE = "scanview.source-segmentation-review-request"
SUMMARY_ARTIFACT_TYPE = "scanview.source-segmentation-review-summary"
REQUEST_MEDIA_TYPE = "application/vnd.scanview.source-segmentation-review-request+json"
...
ATTESTATION = (
    ...
    "ScanView has not verified my identity or credentials."
)
LIMITATIONS = [
    ...
    "The boundary originates in a source-carried DICOM SEG object; ScanView does not authenticate its creator or verify its algorithm, label, codes, accuracy, or clinical meaning.",
...
def _render_page(record: dict[str, Any]) -> bytes:
    ...
    page = f"""<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ScanView source DICOM SEG boundary review</title><style>
...
def _readme() -> bytes:
    return (
        "ScanView source DICOM SEG boundary review\n\n"
        ...
        "  scanview-agent validate-source-segmentation-review review.zip '/path/to/DICOM-root'\n\n"
